module uemep_configuration
    ...
    use uEMEP_definitions, only: n_population_index, num_var_nc_name, n_pollutant_nc_index, n_source_nc_index, &
        n_compound_nc_index, num_var_population_nc, num_var_landuse_nc, UTM_projection_index, &
...
contains
    ...
    subroutine allocate_config_arrays()
        ...
        call set_config_arrays_initial_values()

    end subroutine allocate_config_arrays

    subroutine set_config_arrays_initial_values()
    ...
    end subroutine set_config_arrays_initial_values
